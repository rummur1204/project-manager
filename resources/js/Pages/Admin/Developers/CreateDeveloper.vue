...
const submit = () => {
  form.post(route('admin.developers.store'), {
    onSuccess: () => router.visit('/admin/developers')
  })
}
</script>
  ...
  <div class="flex h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white shadow-lg">
      ...
      <nav class="p-4 space-y-2">
        ...
        <a href="/admin/developers" class="block px-4 py-2 rounded-lg bg-blue-100 text-blue-700 font-semibold ">
          Developers
        </a>
        <a href="/admin/clients" class="block px-4 py-2 rounded-lg hover:bg-blue-50 text-gray-700 ">
          Clients
        </a>
      </nav>
    </aside>
    ...
    <div class="flex-1 flex flex-col">
      <header class="bg-white shadow p-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-800">Add New Developer</h1>
      </header>
